...
const INITIAL_DEMO_REPORTS: WeeklyReport[] = [
  ...
  },
  {
    ...
    end_date: '2026-09-18',
    status: 'soumis',
    submitted_at: '2026-09-18T15:30:00.000Z',
    emailed_at: '2026-09-18T15:30:05.000Z',
    email_recipient: 'direction@hinovgroup.com',
    content_snapshot: [
      {
        id: 'act-38-3-1',
        ...
        date: '2026-09-15',
        day_of_week: 2,
        title: 'Audit des logs d’accès et conformité RGPD / ISO 27001',
        description: 'Vérification de la rétention des journaux d’événements et analyse des anomalies d’authentification.',
        category: 'Sécurité',
        status: 'terminee',
        is_locked: true,
      ...
      },
      {
        ...
        date: '2026-09-17',
        day_of_week: 4,
        title: 'Campagne de test de phishing interne et sensibilisation',
        description: 'Lancement d’une campagne de simulation auprès des 150 collaborateurs HINOV Group.',
        category: 'Sécurité',
        status: 'terminee',
        is_locked: true,
    ...
    difficulties: ['Nécessité de relancer 12 collaborateurs sur le module de formation cybersécurité.'],
    perspectives: ['Présentation des résultats de l’audit au DSI et au Directeur Général.'],
    created_at: '2026-09-14T08:00:00.000Z',
    author: {
      id: 'demo-collab-3',
  ...
  },
  {
    ...
    end_date: '2026-09-25',
    status: 'soumis',
    submitted_at: '2026-09-21T09:30:00.000Z',
    emailed_at: '2026-09-21T09:30:05.000Z',
    email_recipient: 'direction@hinovgroup.com',
    content_snapshot: [
      {
        id: 'act-ad-1',
    ...
    difficulties: ['Disponibilité restreinte de l’équipe marketing pour validation des assets visuels.'],
    perspectives: ['Finalisation des tests d’utilisabilité et validation des KPI de conversion.'],
  ...
  {
    id: 'rep-38-2026-demo-director-1',
    ...
    end_date: '2026-09-18',
    status: 'soumis',
    submitted_at: '2026-09-18T18:00:00.000Z',
    emailed_at: null,
    email_recipient: 'Non envoyé (Rapport Directeur)',
    content_snapshot: [
      {
        id: 'act-38-dir-1',
        user_id: 'demo-director-1',
        date: '2026-09-14',
        day_of_week: 1,
        title: 'Comité Exécutif et gouvernance des filiales régionales',
        description: 'Revue des indicateurs financiers et feuille de route de transformation numérique.',
        category: 'Réunion',
        status: 'terminee',
        is_locked: true,
        created_at: '2026-09-14T09:00:00.000Z',
      },
      {
        ...
        date: '2026-09-16',
        day_of_week: 3,
        title: 'Revue des rapports d’activité des chefs de département',
        description: 'Analyse des blocages signalés et arbitrage des priorités d’allocation d’ingénieurs.',
        category: 'Gestion de projet',
        status: 'terminee',
        is_locked: true,
    ...
    difficulties: ['Pression sur les délais de livraison pour les appels d’offres gouvernementaux.'],
    perspectives: ['Renforcement des effectifs DevOps et validation du plan de formation Cloud.'],
    created_at: '2026-09-14T08:00:00.000Z',
    author: {
      id: 'demo-director-1',
