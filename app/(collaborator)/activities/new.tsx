    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.statusRow}>
          ...
          >
            <Check size={16} color={status === 'terminee' ? COLORS.success : COLORS.textSecondary} />
            <Text style={[styles.statusBtnText, status === 'terminee' && { color: COLORS.success, fontWeight: '700' }]}>
              Terminée
            </Text>
          </TouchableOpacity>
